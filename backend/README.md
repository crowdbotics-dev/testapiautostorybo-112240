...
## Project Structure
    ...
    ├── testapiautostorybo_112240  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_112240`
...
2. Clone this repo and `cd testapiautostorybo_112240`
